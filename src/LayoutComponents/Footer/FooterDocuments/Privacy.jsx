    ...
    return (
        <div className="content-container">
            ...
            <div className="text-container">
                ...
                <h3>Last updated: February 06, 2021</h3>
                <p>
                    This Privacy Policy describes Our policies and procedures on the collection,
                    use and disclosure of Your information when You use the Service and tells You
                    about Your privacy rights and how the law protects You.<br /> <br />
                ...
                <ul>
                    <li>Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to My Site.</li>
                    ...
                    <li>Website refers to My Site, accessible from mkjmworld.com</li>
                ...
                <p>
                    ...
                    the type of mobile Internet browser You use, unique device identifiers and other diagnostic data.<br /> <br />

                    We may also collect information that Your browser sends whenever You visit our Service or when
                    You access the Service by or through a mobile device. <br /> <br /> </p>
                ...
                <ul><li>By email: kjm.matthew@gmail.com</li></ul>
            </p>
            </div>
