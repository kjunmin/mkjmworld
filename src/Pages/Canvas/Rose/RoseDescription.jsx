...
const RoseDescription = props => {
    ...
    return (
        <div>
            ...
            <br /><br />
            <h3 className="header-text">Ring Around the Rosie</h3>
            <ul>
            ...
            <p className="paragraph-text">
                The value of <i>n</i> and <i>d</i> respectively are directly and inversely related to <i>j=k</i> in the form <i>k = n/d</i>. 
